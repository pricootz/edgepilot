...
- The v0.3 development branch adds selectable multi-monitor targeting with reconnect-safe fallback. Mixed-DPI and physical dock/undock behavior still need broader real-desktop testing before release.
